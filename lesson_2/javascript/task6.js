...
const priceProduct1 = parseFloat(prompt('Введіть вартість Товару 1', '0'));
const quantityProduct1 = parseInt(prompt('Введіть кількість одиниць Товару 1', '0'));
const priceProduct2 = parseFloat(prompt('Введіть вартість Товару 2', '0'));
const quantityProduct2 = parseInt(prompt('Введіть кількість одиниць Товару 2', '0'));
const priceProduct3 = parseFloat(prompt('Введіть вартість Товару 3', '0'));
const quantityProduct3 = parseInt(prompt('Введіть кількість одиниць Товару 3', '0'));
...
const totalPriceProduct1 = priceProduct1 * quantityProduct1;
const totalPriceProduct2 = priceProduct2 * quantityProduct2;
const totalPriceProduct3 = priceProduct3 * quantityProduct3;
const totalPriceProducts = totalPriceProduct1 + totalPriceProduct2 + totalPriceProduct3;
//Крок 3. Виведення
document.write(`
            <div class='chekkk'>
                <div class='logo'>
