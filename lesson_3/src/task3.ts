    ...
    //Крок 1. Введення необхідних даних
       ...
       const numberUserAttempt1:number=parseInt(prompt('Пограємо? Вгадайте число від 1 до 5. У Вас 2 спроби. Погнали!', '1')||'0')
        let resultPlay:string
...
if(numberUserAttempt1===randomNumber){
    ...
    const numberUserAttempt2:number=parseInt(prompt('Шкода, але перша спроба невдала. Давай пробуй ще!', '1')||'0')
    if (numberUserAttempt2===randomNumber){
    resultPlay='Супер! Ви виграли з другої спроби! Вітаю!'}

    else{ resultPlay='Нажаль і друга спроба була невдала. Ви програли.'}
}
